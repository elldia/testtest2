  ...
  ready(() => {
    ...
    const initScentFinderSection = () => {
      ...
      const DATA = {
        ...
        smoky: {
          tone: "dark",
          hero: "./images/common/Smoky Woody.png",
          picks: [
            {
              name: "TONKA 25",
            ...
            },
            {
              ...
              img: "./images/common/ENCENS 9-1.jpg",
            },
          ],
        },
      };
    ...
    const initShopConsultationChips = () => {
      ...
      const PRESETS = {
        ...
        "quiet-focus": {
          img: "./images/common/THÉ MATCHA 26-1.jpg",
          alt: "THÉ MATCHA 26",
          title: "THÉ MATCHA 26",
          tag: "그린 티 · 차분한 집중",
        },

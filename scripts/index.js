(() => {
  ...
  ready(() => {
    ...
    const initFinderExperience = () => {
      ...
      const catalog = [
        { name: "Santal 33", scent: "woody", situation: "night", season: "winter", mood: "deep", price: "₩210,000", image: "./images/common/santal33.png", desc: "드라이 우디 중심의 시그니처 무드", note: 91, usage: 84, batch: 86, tag: "우디 · 깊이감 · 따뜻함", meta: "나이트 · 겨울" },
        { name: "Vetiver 46", scent: "smoky", situation: "night", season: "fall", mood: "deep", price: "₩260,000", image: "./images/common/vetver46.png", desc: "스모키·레더 잔향이 길게 남는 타입", note: 88, usage: 80, batch: 83, tag: "스모키 · 다크 · 깊이감", meta: "나이트 · 가을" },
        { name: "Rose 31", scent: "floral", situation: "daily", season: "spring", mood: "calm", price: "₩190,000", image: "./images/common/rose31.png", desc: "플로럴과 스파이스 균형이 좋은 데일리", note: 86, usage: 89, batch: 82, tag: "플로럴 · 부드러움 · 차분함", meta: "데일리 · 봄" },
        { name: "Another 13", scent: "citrus", situation: "office", season: "summer", mood: "fresh", price: "₩180,000", image: "./images/common/an13.png", desc: "깨끗한 머스크 기반의 라이트 무드", note: 82, usage: 87, batch: 80, tag: "머스크 · 상쾌함 · 클린", meta: "오피스 · 여름" },
        { name: "Bergamote 22", scent: "citrus", situation: "daily", season: "summer", mood: "fresh", price: "₩220,000", image: "./images/common/bergamote22.png", desc: "시트러스 중심의 생기 있는 톤", note: 84, usage: 85, batch: 81, tag: "시트러스 · 생동감 · 상쾌함", meta: "데일리 · 여름" },
        { name: "Neroli 36", scent: "floral", situation: "date", season: "spring", mood: "warm", price: "₩230,000", image: "./images/common/neroli36.png", desc: "은은한 플로럴과 따뜻한 잔향", note: 80, usage: 82, batch: 79, tag: "플로럴 · 따뜻함 · 라이트", meta: "데이트 · 봄" },
      ];
      ...
      const updateSticky = (product) => {
        ...
        if (stickyPrice) stickyPrice.textContent = `${product.price} · ★ ${(product.score / 20).toFixed(1)}`;
      };

...
(() => {
  ...
  const PROFILES = {
    ...
    citrus: {
      ...
      price: "₩220,000",
      similar: [
        { name: "Fresh Citrus", fit: "84", notes: "Citrus · Light", img: "./images/common/Fresh Citrus.png" },
    ...
    smoky: {
      ...
      similar: [
        ...
        { name: "ENCENS 9", fit: "83", notes: "Smoky · Leather", img: "./images/common/ENCENS 9-1.jpg" },
  ...
  const STEP_IMAGE_BY_VALUE = {
    scent: {
      ...
      floral: "./images/common/Floral.png",
      citrus: "./images/common/Citrus.jpg",
